...
colors = ["multi-color", "white", "blue", "blonde", "blonde", "blue", "purple", "gray", "pink", "green"]
...
images = [
  ...
  "https://images.unsplash.com/photo-1481044090193-9061560f70d9?ixlib=rb-4.0.3&ixid=M3wxM[…]dlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80",
